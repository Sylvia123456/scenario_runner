...
from srunner.datamanager.icw_ver5.log_format import *
...
class ICW():
    ...
    def TTC(self,hv,rv,dist_hv,dist_rv):
        ...
        if hv.speed < 0.0000001 or rv.speed < 0.0000001:
            ttr_hv,ttr_rv = None,None
            logger.info("The speed of hv or rv of input data is zero.")
            ttc = float("inf")
        else:
    ...
    def filterByLocation(self,hv,rv):
        ...
        # print("xy_vector:",x_vector,y_vector)
    ...
    def filterByAngle(self,hv,rv):
        ...
        # print("delt_orientation:", delt_orientation, delt_heading, flag)
        return flag 
            ...
            if (collisionPnt[0] is not None) and (collisionPnt[1] is not None):
                ...
                if delt_tm is not None:
                    if delt_tm < 5:
                        ...
                        reason = "The TTC is more than five seconds."
                        res = "False"
                else:
...
# {'ID':1}——"POINT(116.40269,39.93182,0)"
# {'ID':6}——"POINT(116.40269,39.93211)"
# {'ID':5}——"POINT(116.40258,39.93211,180)"
...
if __name__ == '__main__':
    ...
    # hv = Point(116.40269,39.93182,0, 8, 0.5)
    # rv = Point(116.40258,39.93211,180, 8, 0.5)

    # hv = Point(0.000455, -0.001159, 270.015363, 8, 0.5)
    # rv = Point(0.000287, -0.001159, 90.005249, 8, 0.5)

    hv = Point(0.001482, 0.002201, 90.135681, 0, 0.5)
    rv = Point(0.002291, 0.002785, 180, 0, 0.5)
